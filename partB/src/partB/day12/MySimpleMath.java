...
public class MySimpleMath {
	...
	//메소드 오버로딩(overloading) : 메소드 시그니처 중에 인자의 타입과 갯수가 다르고 실행 동작이 같을 때
	//     메소드 이름을 동일하게 하여 사용하도록 하는 것입니다.
	
	public static final double PI=3.14;     //변수 선언.(필드)
	                           //static final은 상수(변경될 수 없는 값)
	...
	//두 개의 실수를 곱셈하기.
	public static double multuply(double value1, double value2) {
		return value1*value2;
	}
	//두 개의 실수를 나눗셈하기.
	...
	public static int add(int value1, int value2) {
		...
		//메소드 오버로딩 오류 예시 : 매개변수의 갯수, 형식(즉 시그니처)가 같다.
		//리턴타입만 변경되는 것은 불가능
...
public static long multuply(int value1, int value2) {
	return value1*value2;
}//정수값 최대 2147483647.
//두 개의 정수를 나누기 => 몫
