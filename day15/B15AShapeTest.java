...
public class B15AShapeTest {
	...
	public static void main(String[] args, int ladderShape, int circle) {
		...
		*/
		...
		//1)OLadderShape 객체인 경우 iamLadder() 메소드 실행하세요. index를 사용하는 for문
		for(int i=0;i<shapes.length;i++) {
		...
		System.out.println("==============================");
		//2)OCircle 객체인 경우 iamCircle() 메소드 실행하세요. 항상 for문 사용.
		for(AShape s : shapes) {
