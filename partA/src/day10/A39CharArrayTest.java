...
public class A39CharArrayTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. char 배열을 문자열로 변환");
		tempArr[5] = '*';
		...
		//문자열과 char 배열의 + 연산을 실행하면 char 배열의 자동변환하지 않음. 
		//[C@7a79be86 에서 7a79be86은 해시코드값이고 해시함수를 통해서 만들어지는 4바이트 값.
		//자바의 객체들을 식별하기 위해 객체가 갖는 여러 가지 값들을 복합적으로 계산해서 만듭니다.
