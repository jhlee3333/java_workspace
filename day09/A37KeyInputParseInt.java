...
public class A37KeyInputParseInt {
	...
	public static void main(String[] args) {
		...
		//A36 해결 방법 2: 실제로 사용할 방식입니다. 모든 키보드 입력은 nextLine()으로 합니다.
		...
		//   앞으로 배울 여러 가지 데이터 교환에서도 문자열이 기본입니다.
		
		//Boolean, Character, Integer, Long, Double, ... 원시 타입에 대한 처리 기능을 갖은 Wrapper 클래스
		// ㄴ String에서 int, double, long, ... 원시 타입으로 변환 : Wrapper 클래스.parseXXXX("문자열");
		// ㄴ int, double, long, ... 원시 타입에서 String으로 변환 : String.valueOf(원시타입데이터);
